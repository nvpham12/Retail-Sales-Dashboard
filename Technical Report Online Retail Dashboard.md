...
## Data Processing
- Combined multiple CSV sheets and removed duplicates/missing values.
- Standardized country names and cleaned dates/timestamps.
- Calculated sales column and reordered fields for consistency.
...
1. **Data Preparation**
   ...
   - Unioned tables, cleaned data, and calculated sales metrics.
2. **Query Pipeline**
   - Consolidated multiple queries into a single optimized pipeline.
